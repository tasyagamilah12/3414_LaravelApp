...
onsubmit="return confirm('Anda yakin ingin menghapus data ini?');">
 @csrf
 @method('DELETE')
 <button type="submit" class="bg-red-100 text-red-600
border border-red-200 px-3 py-1.5 rounded text-sm fontsemibold hover:bg-red-600 hover:text-white
transition">Hapus</button>
</form>
